          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900">ProCura</span>
              </Link>
            </div>
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <Link to="/registro" className="text-gray-600 hover:text-blue-600 transition-colors">
                Registrarse
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">ProCura</span>
              </div>
              <p className="text-gray-400 mb-4">
                La plataforma integral para la gestión de clínicas médicas. 
                Simplifica tus procesos, mejora la atención y optimiza tu negocio.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Guías</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Contacto</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Estado</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800">
            <p className="text-gray-400 text-sm text-center">
              © 2025 ProCura. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
